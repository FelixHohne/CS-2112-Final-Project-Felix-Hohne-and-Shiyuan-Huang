...
**While we are unable to show our actual code due to Cornell University academic integrity policy, we provide several examples of features we implemented.**
